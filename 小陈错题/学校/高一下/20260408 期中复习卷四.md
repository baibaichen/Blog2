...
11. ⚠️将函数 $f(x) = \sin(\omega x + \dfrac{\pi}{6})(\omega\in R$ 且 $\omega\neq0)$ 的图象上所有点的横坐标变为原来的 $2$ 倍，纵坐标保持不变，若所得函数的图象与函数 $g(x) = \cos(x + \varphi)(0<\varphi<\pi)$ 的图象重合，则 $\tan(\dfrac{\pi}{3}\omega + \varphi) =$\_\_\_\_\_\_\_\_\_\_\_\_。
12. ⚠️已知函数 $f(x) = \sqrt{3}\sin\omega x - \cos\omega x(\omega>0)$ 在区间 $[-\dfrac{\pi}{3},\dfrac{3\pi}{4}]$ 上单调递增，且在区间 $[0,\pi]$ 上只取得一次最大值，则 $\omega$ 的最大值是\_\_\_\_\_\_\_\_\_\_\_\_。
