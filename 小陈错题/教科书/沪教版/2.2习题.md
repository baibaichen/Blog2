...
**(4)** $\overline{A \cup B} = \mathbb{R} \setminus \left[(-\infty, 1) \cup [3, +\infty)\right] = [1, 3)$  
**解集：** $\boxed{[1, 3)}$
...
- 移项：$\frac{5 - 2(x + 2)}{x + 2} \leqslant 0$ → $\frac{1 - 2x}{x + 2} \leqslant 0$  
