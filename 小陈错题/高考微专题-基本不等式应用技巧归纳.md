...
> 【答案】4
>
> 【解析】🔑 关键是如何想到原式可以化简为 $1+\dfrac{4}{a}+\dfrac{1}{b+1}$
> $$
> \begin{aligned}
> \dfrac{a^{2}+4}{a}+\dfrac{b^{2}}{b+1} &= a+\dfrac{4}{a} ++\dfrac{(b^2-1) +1}{b+1} \\
> &=a+\dfrac{4}{a}+(b-1)+\dfrac{1}{b+1}\\
> &=1+\dfrac{4}{a}+\dfrac{1}{b+1}\\
> &=1+ \dfrac{1}{3}\left(\dfrac{4}{a}+\dfrac{1}{b+1}\right)[a+(b+1)]\\
> &=1+\dfrac{1}{3}\left[5+\dfrac{a}{b+1}+\dfrac{4(b+1)}{a}\right] \\
> &\geq 1 + \dfrac{1}{3} \times (5+4)=4\\
> \end{aligned}
> $$
>
