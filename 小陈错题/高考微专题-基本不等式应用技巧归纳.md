...
【解析】解法一：由$ x+2y+3z=1 $，$ x^{2}+4y^{2}+9z^{2}=1 $，得到$ x+2y=1-3z $，$ x^{2}+4y^{2}=1-9z^{2}$，则由柯西不等式$(1^{2}+1^{2})[x^{2}+(2y)^{2}]\geq(x+2y)^{2}$，则 $2(1-9z^{2})\geq(1-3z)^{2}$，解得$ -\dfrac{1}{9}\leq z\leq\dfrac{1}{3}$，则 $z_{min}=-\dfrac{1}{9}$
